...
public class StudentController implements Initializable {
    ...
    protected void addstudent() throws IOException {
        ...
        newWindow.setTitle("Add Physics");
    ...
    protected void Editstudent() throws IOException {
        Stage newWindow = new Stage();
        newWindow.setTitle("Edit Physics");
    ...
    protected void currentStudent() {
        ...
        try {
            this.List = this.c.RetrieveStudent("Current","all","all","all","Physics");
    ...
    protected void Exstudent() {
        ...
        try {
            this.List = this.c.RetrieveStudent("Ex","all","all","all","Physics");
        } catch (SQLException var2) {
            throw new RuntimeException(var2);
        }
    ...
    protected void Allstudent() {
        ...
        try {
            this.List = this.c.RetrieveStudent("All Students","all","all","all","Physics");
        } catch (SQLException var2) {
            throw new RuntimeException(var2);
        }
...
@FXML
    ...
    try {
        if (chbox.getValue().equals("Current")){
            this.List = this.c.RetrieveStudent("Current",clas.getValue(),plan.getValue(),batch.getValue(),"Physics");
        }else if(chbox.getValue().equals("Ex")) {
            this.List = this.c.RetrieveStudent("Ex",clas.getValue(),plan.getValue(),batch.getValue(),"Physics");
        }else if(chbox.getValue().equals("All Students")) {
            this.List = this.c.RetrieveStudent("All Students",clas.getValue(),plan.getValue(),batch.getValue(),"Physics");
        }
...
@FXML
   void print() throws FileNotFoundException {
    ...
    if (file != null) {
        ...
        Text title=new Text("Physics Students Data.").setFontSize(12f);
