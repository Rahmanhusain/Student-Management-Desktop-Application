...
public class MathsController implements Initializable {
    ...
    protected void addstudent() throws IOException {
        ...
        newWindow.setTitle("Add Maths");
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("modelfxml/add_Maths.fxml"));
    ...
    protected void Editstudent() throws IOException {
        Stage newWindow = new Stage();
        newWindow.setTitle("Edit Maths");
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("modelfxml/edit_Maths.fxml"));
        newWindow.getIcons().add(new Image(Objects.requireNonNull(HelloApplication.class.getResource("styles/slogo.png")).openStream()));
        newWindow.setScene(new Scene(loader.load()));
        newWindow.setMaximized(false);
        newWindow.setResizable(false);
    ...
    protected void currentStudent() {
        ...
        try {
            this.List = this.c.RetrieveStudent("Current","all","all","all","Maths");
    ...
    protected void Exstudent() {
        ...
        try {
            this.List = this.c.RetrieveStudent("Ex","all","all","all","Maths");
        } catch (SQLException var2) {
            throw new RuntimeException(var2);
        }
    ...
    protected void Allstudent() {
        ...
        try {
            this.List = this.c.RetrieveStudent("All Students","all","all","all","Maths");
        } catch (SQLException var2) {
            throw new RuntimeException(var2);
        }
    ...
    void filter() {
        ...
        try {
            if (chbox.getValue().equals("Current")){
                this.List = this.c.RetrieveStudent("Current",clas.getValue(),plan.getValue(),batch.getValue(),"Maths");
            }else if(chbox.getValue().equals("Ex")) {
                this.List = this.c.RetrieveStudent("Ex",clas.getValue(),plan.getValue(),batch.getValue(),"Maths");
            }else if(chbox.getValue().equals("All Students")) {
                this.List = this.c.RetrieveStudent("All Students",clas.getValue(),plan.getValue(),batch.getValue(),"Maths");
            }
    ...
    void print() throws FileNotFoundException {
        ...
        if (file != null) {
            ...
            Text title=new Text("Maths Students Data.").setFontSize(12f);
