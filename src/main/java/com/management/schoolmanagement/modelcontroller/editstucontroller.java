...
public class editstucontroller implements Initializable {
   ...
   @FXML
    ...
    int search() throws SQLException {
        ArrayList<Student> editlist = this.con.RetrieveStudent("All Students","all","all","all","Physics");
    ...
    void setSearchbtn() throws SQLException {
        ArrayList<Student> list = this.con.RetrieveStudent("All Students","all","all","all","Physics");
        int i = this.search();
        if (i != -1) {
    ...
    void setEdit() {
        this.con.EditStudent(Long.parseLong(Id.getText()),Name.getText().toUpperCase(),Class.getValue(),Father.getText().toUpperCase(),sname.getText(),
                ...
                batch.getValue(),status.getValue(),Long.parseLong(searchid.getText()),"Physics");
    ...
    void setDelete() {
        ...
        this.con.Delstudent(sid,"Physics");
