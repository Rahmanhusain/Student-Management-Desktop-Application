...
public class editChemistry implements Initializable {
    ...
    public editChemistry() {
    }

    int search() throws SQLException {
        ArrayList<Student> editlist = this.con.RetrieveStudent("All Students","all","all","all","Chemistry");
    ...
    void setSearchbtn() throws SQLException {
        ArrayList<Student> list = this.con.RetrieveStudent("All Students","all","all","all","Chemistry");
        int i = this.search();
        if (i != -1) {
    ...
    void setEdit() {
        this.con.EditStudent(Long.parseLong(Id.getText()),Name.getText().toUpperCase(),Class.getValue(),Father.getText().toUpperCase(),sname.getText(),
                ...
                batch.getValue(),status.getValue(),Long.parseLong(searchid.getText()),"Chemistry");
    ...
    void setDelete() {
        ...
        this.con.Delstudent(sid,"Chemistry");
